-- =====================================================================
--  TCG Tracker - Schema v1 (Pokémon-specifico) - SQLite
--  CONSERVATO solo per il BOOTSTRAP dal seed (db/02_seed_sets_cards.sql):
--  init_db crea questo schema, applica il seed, poi lo migra a v2
--  (db/migrate_001_multigame.py). Lo schema CORRENTE e' db/schema_sqlite.sql (v2).
-- =====================================================================
...
SELECT s.display_order set_order, s.pack_code, s.set_name,
       c.id card_id, c.card_code, c.model_number, c.full_name, c.name_en, c.rarity,
